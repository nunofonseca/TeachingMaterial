...
# import the data
aln_chr4=readGAlignmentPairsFromBam("untreated3.bam", use.names=T, param=param)
aln_chr4=readGAlignmentPairsFromBam("untreated3.bam",index="untreated3.bam.bai", use.names=T, param=param)
aln_chr4
```
